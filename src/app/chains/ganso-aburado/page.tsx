...
export const metadata: Metadata = {
  title: 'Ganso Aburado 蜈・･匁ｲｹ蝣・| Healthy Abura Soba | Japan Food Chains',
  description: 'Innovative abura soba: hybrid noodles, healthy concept, free oolong tea.',
  keywords: [
    'ganso aburado', '蜈・･匁ｲｹ蝣・, 'abura soba', '豐ｹ縺昴・',
    'hybrid noodles', 'modern innovation', 'healthy tea',
    'modern design', 'pasta noodles', 'healthy concept'
  ],
  openGraph: {
    title: 'Ganso Aburado: Healthy and Innovative Abura Soba | Japan Food Chains',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 bg-indigo-600 rounded-lg flex items-center justify-center">
                <span className="text-white text-2xl font-bold">蝣・/span>
              </div>
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Ganso Aburado</h1>
                <p className="text-lg text-gray-600">蜈・･匁ｲｹ蝣・| 縺後ｓ縺昴≠縺ｶ繧峨←縺・/p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-indigo-200 rounded-lg p-4">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="text-gray-600 japanese-text">蜈・･匁ｲｹ縺昴・</p>
                      </div>
                      <span className="text-2xl font-bold text-indigo-600">ﾂ･880</span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div><strong>Portions:</strong>荳ｦ逶・螟ｧ逶・迚ｹ螟ｧ逶・(same price)</div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="border border-green-200 rounded-lg p-4">
                      ...
                      <p className="text-gray-600 text-sm mb-2">繝吶ず繧ｿ繝悶Ν豐ｹ縺昴・ - ﾂ･880</p>
                    ...
                    <div className="border border-blue-200 rounded-lg p-4">
                      ...
                      <p className="text-gray-600 text-sm mb-2">鮟堤ワ鮴崎幻 - Free!</p>
                      <p className="text-gray-700 text-sm">
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <h3 className="font-bold text-indigo-800 mb-2">尚 Modern Ambiance</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <h3 className="font-bold text-indigo-800 mb-2">嵯 Tea Ritual</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <h3 className="font-bold text-indigo-800 mb-2">骨 Hybrid Technique</h3>
                    <p className="text-gray-700 text-sm">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li>窶｢ <strong>Enriched fibers:</strong> Hybrid noodles richer in fiber</li>
                      <li>窶｢ <strong>Reduced sodium:</strong> Less salty tare, preserved taste</li>
                      <li>窶｢ <strong>Antioxidants:</strong> Black oolong tea with polyphenols</li>
                      <li>窶｢ <strong>Digestion:</strong> Selected ingredients for digestibility</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li>窶｢ <strong>Responsible sourcing:</strong> Prioritized local ingredients</li>
                      <li>窶｢ <strong>Eco-friendly packaging:</strong> Recyclable materials</li>
                      <li>窶｢ <strong>Reduced waste:</strong> Optimized portions</li>
                      <li>窶｢ <strong>Energy:</strong> Low-consumption equipment</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">ﾂ･880-1080 (all sizes)</p>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6">
                <h3 className="text-lg font-bold text-blue-800 mb-4">庁 Travel Tips</h3>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-6">
                <h3 className="text-lg font-bold text-amber-800 mb-4">売 VS Tokyo Abura-gumi</h3>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-indigo-500 pl-3">
                    ...
                    <p className="text-sm text-gray-600">襍､蝮ょｺ・/p>
                  ...
                  <div className="border-l-4 border-purple-500 pl-3">
                    ...
                    <p className="text-sm text-gray-600">逕ｰ逕ｺ蠎・/p>
                  ...
                  <div className="border-l-4 border-blue-500 pl-3">
                    ...
                    <p className="text-sm text-gray-600">逾櫁ｰｷ逕ｺ蠎・/p>
