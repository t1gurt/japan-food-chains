...
export const metadata: Metadata = {
  title: 'Tokyo Abura-gumi 譚ｱ莠ｬ豐ｹ邨・| Classic Abura Soba | Japan Food Chains',
  description: 'Classic abura soba specialist. Quality noodles, secret tare, unique pricing for all sizes.',
  keywords: [
    'tokyo abura-gumi', '譚ｱ莠ｬ豐ｹ邨・ｷ乗悽蠎・, 'abura soba', '豐ｹ縺昴・',
  ...
  alternates: {
    canonical: '/chains/tokyo-abura-gumi',
  },
  robots: {
    index: true,
    follow: true,
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 bg-amber-600 rounded-lg flex items-center justify-center">
                <span className="text-white text-2xl font-bold">豐ｹ</span>
              </div>
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Tokyo Abura-gumi Sﾅ紘onten</h1>
                <p className="text-lg text-gray-600">譚ｱ莠ｬ豐ｹ邨・ｷ乗悽蠎・| 縺ｨ縺・″繧・≧縺ゅ・繧峨＄縺ｿ縺昴≧縺ｻ繧薙※繧・/p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="prose prose-orange max-w-none">
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Tokyo Abura-gumi Sﾅ紘onten is <strong>THE reference for traditional abura soba</strong>, 
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-l-4 border-red-500 pl-4">
                    ...
                    <p className="text-gray-700">
                      Remarkable innovation: <strong>all sizes at the same price (ﾂ･880)</strong>. 
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-amber-200 rounded-lg p-4">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="text-gray-600 japanese-text">豐ｹ縺昴・</p>
                      </div>
                      <span className="text-2xl font-bold text-amber-600">ﾂ･880</span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div><strong>Portions:</strong> 荳ｦ逶・螟ｧ逶・W逶・(same price)</div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="border border-orange-200 rounded-lg p-4">
                      ...
                      <p className="text-gray-600 text-sm mb-2">蜻ｳ邇・(Ajitsuke Tamago) - ﾂ･100</p>
                    ...
                    <div className="border border-green-200 rounded-lg p-4">
                      ...
                      <p className="text-gray-600 text-sm mb-2">霑ｽ縺・｣ｯ - ﾂ･100</p>
                      <p className="text-gray-700 text-sm">
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <h3 className="font-bold text-orange-800 mb-2">骨 Step 3: Tasting</h3>
                    <p className="text-gray-700 text-sm">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">ﾂ･880-1,080 (all sizes)</p>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6">
                <h3 className="text-lg font-bold text-green-800 mb-4">庁 Travel Tips</h3>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-amber-500 pl-3">
                    ...
                    <p className="text-sm text-gray-600">襍､蝮りｦ矩刋蠎・/p>
                  ...
                  <div className="border-l-4 border-orange-500 pl-3">
                    ...
                    <p className="text-sm text-gray-600">譁ｰ讖句ｺ・/p>
                  ...
                  <div className="border-l-4 border-red-500 pl-3">
                    ...
                    <p className="text-sm text-gray-600">蠎・ｰｾ蠎・/p>
