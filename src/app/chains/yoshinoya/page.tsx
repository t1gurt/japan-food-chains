          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="prose prose-orange max-w-none">
                ...
                <div className="bg-gray-50 p-4 rounded-lg my-4">
                  ...
                  <p className="text-gray-700 text-sm">
                    ...
                    Through a bowl of gyūdon, you'll touch 125 years of Japanese history, 
              ...
              <div className="space-y-8">
                ...
                <div className="border-l-4 border-orange-500 pl-6">
                  ...
                  <p className="text-gray-700 mb-3">
                    ...
                    and tasty food. Inspired by the trendy "gyūmeshi," he perfected the recipe 
                    to create <strong>modern gyūdon</strong>.
                  </p>
                ...
                <div className="border-l-4 border-red-500 pl-6">
                  ...
                  <p className="text-gray-700 mb-3">
                    ...
                    that stunned the industry: <strong>completely stop selling gyūdon for 2 years and 7 months</strong>, 
                ...
                <div className="border-l-4 border-yellow-500 pl-6">
                  ...
                  <p className="text-gray-700">
                    ...
                    Yoshinoya continues to carry the soul of authentic gyūdon while adapting 
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-8">
                {/* Essential basics */}
                <div className="border-l-4 border-orange-500 pl-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">🍚 The Basics: Your Absolute References</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-orange-900 mb-2">🐷 Butadon (Pork)</h4>
                      <div className="text-sm space-y-1">
                ...
                <div className="border-l-4 border-purple-500 pl-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">🎯 "Secret Codes": Customize Like a Pro</h3>
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div className="space-y-2">
                          ...
                          <div><strong>Salad:</strong> ¥120 (necessary freshness)</div>
                          <div><strong>Oshinko:</strong> ¥120 (traditional pickles)</div>
                        </div>
                        <div className="space-y-2">
                          <div><strong>Karaage:</strong> ¥250 (crispy fried chicken)</div>
                          <div><strong>Gyoza:</strong> ¥150 (pan-fried dumplings)</div>
                          <div><strong>Soft Cream:</strong> ¥150 (classic dessert)</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-8">
                ...
                <div className="border-l-4 border-orange-500 pl-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">📋 The Process: Simple but Precise</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Quick meal under ¥500</div>
                  </div>
                </div>
              </div>
            </div>
