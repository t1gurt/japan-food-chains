...
export const metadata: Metadata = {
  title: "Gyoza no Ohsho 餃子の王将 | King of Gyoza | Japan Food Chains",
  ...
  alternates: {
    canonical: '/chains/gyoza-no-ohsho',
  },
  robots: {
    index: true,
    follow: true
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-blue-800 mb-2">🎟️ Mandatory First Visit</h3>
