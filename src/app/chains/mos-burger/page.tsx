...
export const metadata: Metadata = {
  title: "MOS Burger 繝｢繧ｹ繝舌・繧ｬ繝ｼ | Japanese Burger Chain | Japan Food Chains",
  description: "Inventor of Rice Burger and Teriyaki. Premium quality, unique Japanese flavors.",
  keywords: [
    'mos burger', '繝｢繧ｹ繝舌・繧ｬ繝ｼ', 'premium burgers', 'fresh ingredients',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600">繝｢繧ｹ繝舌・繧ｬ繝ｼ | 繧ゅ☆縺ｰ繝ｼ縺後・</p>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-l-4 border-green-500 pl-4">
                    ...
                    <p className="text-gray-700">
                      Sakuji ﾅ荊suka founded MOS Burger in <strong>Narimasu, Tokyo</strong> with a 
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-green-600 font-bold text-sm">笨・/span>
                    </div>
                    <div>
                    ...
                    <table className="min-w-full border border-gray-200">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        <tr>
                          ...
                          <td className="px-4 py-4 text-sm font-medium text-gray-900">ﾂ･380</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-4">
                          ...
                          <td className="px-4 py-4 text-sm font-medium text-gray-900">ﾂ･320-420</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-4">
                          ...
                          <td className="px-4 py-4 text-sm font-medium text-gray-900">ﾂ･520</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-4">
                          ...
                          <td className="px-4 py-4 text-sm text-gray-700">
                            Spicy beef, jalapeﾃｱos, hot sauce, fresh vegetables
                          </td>
                          <td className="px-4 py-4 text-sm font-medium text-gray-900">ﾂ･420</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-4">
                          ...
                          <td className="px-4 py-4 text-sm font-medium text-gray-900">ﾂ･360</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="border border-gray-200 rounded p-4">
                      ...
                      <div className="text-sm text-gray-600">ﾂ･340</div>
                    </div>
                    <div className="border border-gray-200 rounded p-4">
                      ...
                      <div className="text-sm text-gray-600">ﾂ･380</div>
                    </div>
                    <div className="border border-gray-200 rounded p-4">
                      <h4 className="font-semibold text-gray-900 mb-2">Rice Burger Kinpira</h4>
                      <p className="text-sm text-gray-700 mb-2">Rice buns, kinpira (Japanese sautﾃｩed vegetables)</p>
                      <div className="text-sm text-gray-600">ﾂ･320</div>
                    </div>
                    <div className="border border-gray-200 rounded p-4">
                      ...
                      <div className="text-sm text-gray-600">ﾂ･420</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-xl p-6 border border-red-200">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <div className="bg-white p-4 rounded-lg border-l-4 border-red-500 mb-4">
                          <h5 className="font-bold text-red-700 mb-2">The Secret: Miso Sauce ､ｫ</h5>
                      ...
                      <div>
                        <h4 className="text-lg font-bold text-gray-900 mb-3">識 Technique & Philosophy</h4>
                    ...
                    <div className="mt-6 bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                      <h5 className="font-bold text-yellow-800 mb-2">庁 Tasting Tip</h5>
                      <p className="text-sm text-gray-700">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="border border-gray-200 rounded p-4">
                      ...
                      <div className="text-sm text-gray-600">S: ﾂ･150 / M: ﾂ･200</div>
                    </div>
                    <div className="border border-gray-200 rounded p-4">
                      ...
                      <div className="text-sm text-gray-600">ﾂ･220</div>
                    </div>
                    <div className="border border-gray-200 rounded p-4">
                      ...
                      <div className="text-sm text-gray-600">ﾂ･280</div>
                    </div>
                    <div className="border border-gray-200 rounded p-4">
                      ...
                      <div className="text-sm text-gray-600">ﾂ･180</div>
                    </div>
                    <div className="border border-gray-200 rounded p-4">
                      ...
                      <div className="text-sm text-gray-600">ﾂ･160</div>
                    </div>
                    <div className="border border-gray-200 rounded p-4">
                      ...
                      <div className="text-sm text-gray-600">ﾂ･250</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <div className="text-gray-600">+ﾂ･250 compared to burger only</div>
                    </div>
                    <div>
                      <strong>Premium Set</strong> - Burger + Onion Rings + Drink
                      <div className="text-gray-600">+ﾂ･300 compared to burger only</div>
                    </div>
                    <div>
                      <strong>Family Set</strong> - 2 Burgers + 2 Fries + 2 Drinks
                      <div className="text-gray-600">Save ﾂ･200</div>
                    </div>
                    <div>
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <div className="text-gray-500 text-xs">繝｢繧ｹ繝舌・繧ｬ繝ｼ繧ｻ繝・ヨ縺上□縺輔＞</div>
                      </div>
                      <div>
                        <div className="font-medium text-gray-900">Rice Burger:</div>
                        <div className="text-gray-700">&quot;Raisu bﾄ“ﾄ・onegaishimasu&quot;</div>
                        <div className="text-gray-500 text-xs">繝ｩ繧､繧ｹ繝舌・繧ｬ繝ｼ縺企｡倥＞縺励∪縺・/div>
                      </div>
                      <div>
                        <div className="font-medium text-gray-900">To go:</div>
                        <div className="text-gray-700">&quot;Tﾄ徒uauto de&quot;</div>
                        <div className="text-gray-500 text-xs">繝・う繧ｯ繧｢繧ｦ繝医〒</div>
                      </div>
                      <div>
                        <div className="font-medium text-gray-900">Thank you for the meal:</div>
                        <div className="text-gray-700">&quot;Gochisﾅ行ama deshita&quot;</div>
                        <div className="text-gray-500 text-xs">縺斐■縺昴≧縺輔∪縺ｧ縺励◆</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 text-xs">
                      <div className="bg-white p-3 rounded">
                        <span className="font-bold text-blue-700">訣 In the West: </span>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">ﾂ･320-520</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Complete set</span>
                    <span className="font-medium">ﾂ･600-800</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Sides</span>
                    <span className="font-medium">ﾂ･150-280</span>
                  </div>
                  <div className="border-t border-gray-200 pt-2 mt-2">
                    <div className="flex justify-between font-medium">
                      <span className="text-gray-900">Average meal</span>
                      <span className="text-gray-900">ﾂ･700-1,000</span>
                    </div>
                  </div>
                </div>
              </div>
