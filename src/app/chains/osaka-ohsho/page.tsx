...
export const metadata: Metadata = {
  title: 'Osaka Ohsho 螟ｧ髦ｪ邇句ｰ・| Osaka-Style Gyoza | Japan Food Chains',
  description: 'Crispy gyoza, signature yakimeshi. Friendly Osaka street food atmosphere.',
  keywords: 'Osaka Ohsho, 螟ｧ髦ｪ邇句ｰ・ Japanese Chinese restaurant, gyoza, yakimeshi, Osaka Chinese cuisine',
  openGraph: {
  ...
  const menuItems = [
    {
      ...
      items: [
        { name: "Gyoza (6 pieces)", japanese: "鬢・ｭ・, price: "ﾂ･350", description: "Crispy Osaka-style gyoza, thicker than average" },
        { name: "Gyoza (12 pieces)", japanese: "鬢・ｭ・, price: "ﾂ･650", description: "Family portion, perfect for sharing" },
        { name: "Ebi Chili", japanese: "繧ｨ繝薙メ繝ｪ", price: "ﾂ･680", description: "Shrimp in spicy sauce, popular specialty" },
        { name: "Harumaki", japanese: "譏･蟾ｻ縺・, price: "ﾂ･420", description: "Crispy spring rolls" }
      ]
    },
    {
      category: "Rice & Noodles",
      items: [
        { name: "Yakimeshi", japanese: "辟ｼ縺阪ａ縺・, price: "ﾂ･650", description: "Osaka Ohsho's signature fried rice, light and fragrant" },
        { name: "Tenshin-han", japanese: "螟ｩ豢･鬟ｯ", price: "ﾂ･750", description: "Rice topped with crab omelet and sweet-sour sauce" },
        { name: "Chinese Ramen", japanese: "荳ｭ闖ｯ繝ｩ繝ｼ繝｡繝ｳ", price: "ﾂ･580", description: "Chinese-style ramen with clear, flavorful broth" },
        { name: "Yakisoba", japanese: "辟ｼ縺阪◎縺ｰ", price: "ﾂ･680", description: "Stir-fried noodles with vegetables and meat" }
      ]
    },
    {
      category: "Main Dishes",
      items: [
        { name: "Subuta", japanese: "驟｢雎・, price: "ﾂ･880", description: "Sweet and sour pork with colorful vegetables" },
        { name: "Mapo Tofu", japanese: "鮗ｻ蟀・ｱ・・", price: "ﾂ･750", description: "Spicy tofu sauce, milder than Chinese version" },
        { name: "Karaage", japanese: "蜚先恕縺・, price: "ﾂ･650", description: "Crispy fried chicken marinated in Chinese spices" },
        { name: "Hoikoro", japanese: "繝帙う繧ｳ繝ｼ繝ｭ繝ｼ", price: "ﾂ･820", description: "Stir-fried pork with cabbage and miso, hearty dish" }
      ]
    }
  ];
            ...
            <div>
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-3xl text-gray-600 japanese-text mb-2">螟ｧ髦ｪ邇句ｰ・/p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-600">ﾂ･500-1300</span>
                </div>
                <div className="flex justify-between">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-orange-50 p-6 rounded-xl border border-orange-200">
              <div className="text-3xl mb-4 text-center">忽</div>
            ...
            <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
              <div className="text-3xl mb-4 text-center">墾</div>
