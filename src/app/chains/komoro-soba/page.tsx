...
export default function KomoroSobaPage() {
  ...
  const drinkOptions = [
    { name: "Hot Green Tea", japanese: "辭ｱ縺・♀闌ｶ", price: "Free" },
    { name: "Cold Water", japanese: "蜀ｷ豌ｴ", price: "Free" },
    { name: "Asahi Beer", japanese: "繧｢繧ｵ繝偵ン繝ｼ繝ｫ", price: "ﾂ･350" },
    { name: "Hot Sake", japanese: "辭ｱ辯・, price: "ﾂ･280" },
    { name: "Orange Juice", japanese: "繧ｪ繝ｬ繝ｳ繧ｸ繧ｸ繝･繝ｼ繧ｹ", price: "ﾂ･180" }
  ];
      ...
      <div className="min-h-screen bg-gray-50">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  <span className="text-6xl mr-4">諸・・/span>
                  <div>
                    <h1 className="text-4xl md:text-5xl font-bold mb-2">Komoro Soba</h1>
                    <p className="text-2xl text-blue-200 japanese-text">蟆剰ｫｸ縺昴・</p>
                  </div>
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center">
                    <span className="text-green-400 mr-3">笨・/span>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  ...
                  <span className="block text-lg text-gray-600 mt-2">菫｡蟾槭・驕ｺ逕｣</span>
                </h2>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-start">
                      <span className="text-indigo-500 mr-2 mt-0.5">窶｢</span>
                ...
                <div className="bg-green-50 rounded-lg border border-green-200 p-6">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">ﾂ･290-370</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Premium soba:</span>
                      <span className="font-bold">ﾂ･450-530</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Complete sets:</span>
                      <span className="font-bold">ﾂ･580-680</span>
                    </div>
                    <div className="border-t pt-2 mt-2">
                      <div className="flex justify-between">
                        <span className="font-medium">Average meal:</span>
                        <span className="font-bold text-green-600">ﾂ･400</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              Signature Menu
              <span className="block text-lg text-gray-600 mt-2">逵区攸繝｡繝九Η繝ｼ</span>
            </h2>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              Tachi-gui Experience Guide
              <span className="block text-lg text-gray-600 mt-2">遶九■鬟溘＞菴馴ｨ薙ぎ繧､繝・/span>
            </h2>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              <div className="text-center p-6 bg-indigo-50 rounded-xl border border-indigo-200">
                <div className="text-3xl mb-4">坎</div>
              ...
              <div className="text-center p-6 bg-green-50 rounded-xl border border-green-200">
                <div className="text-3xl mb-4">ｧ・/div>
            ...
            <div className="bg-indigo-50 rounded-xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-bold text-gray-900 mb-3">笨・Appropriate Behavior</h4>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li>窶｢ Eat standing without leaning excessively</li>
                    <li>窶｢ Consume quickly (5-10 minutes ideal)</li>
                    <li>窶｢ Engage in conversation with other customers</li>
                    <li>窶｢ Slurp the noodles loudly</li>
                    <li>窶｢ Free up your spot quickly</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-bold text-gray-900 mb-3">庁 Expert Tips</h4>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li>窶｢ Quiet period: 2pm-4pm on weekdays</li>
                    <li>窶｢ Morning rush: 7am-9am (authentic experience)</li>
                    <li>窶｢ Start with Mori Soba to appreciate the buckwheat</li>
                    <li>窶｢ Watch the regulars to learn</li>
                    <li>窶｢ Don't hesitate to ask for recommendations</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              ...
              <span className="block text-lg text-gray-600 mt-2">鬟ｲ縺ｿ迚ｩ繝ｻ莉倥￠蜷医ｏ縺・/span>
            </h2>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <h3 className="text-xl font-bold text-gray-900 mb-4">嵯 Available Drinks</h3>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <h3 className="text-xl font-bold text-gray-900 mb-4">左 The Art of Accompaniment</h3>
        ...
        <section className="py-16 bg-indigo-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              ...
              <span className="block text-lg text-gray-600 mt-2">菫｡蟾槭・譁・喧驕ｺ逕｣</span>
            </h2>

            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <div className="text-3xl mb-4">諸・・/div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <div className="text-3xl mb-4">垳</div>
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-200">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-bold text-gray-900 mb-3">識 Pure Authenticity</h4>
                  ...
                  <h4 className="font-bold text-gray-900 mb-3">虫 Exceptional Quality</h4>
                  <p className="text-gray-600 text-sm">
                ...
                <div>
                  ...
                  <h4 className="font-bold text-gray-900 mb-3">笞｡ Urban Energy</h4>
                  <p className="text-gray-600 text-sm">
