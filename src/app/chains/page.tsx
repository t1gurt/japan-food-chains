  ...
  const chains = useMemo(() => [
    {
      ...
      nameJp: '螳牙ｮ・,
      category: 'Yakiniku',
      description: 'Affordable charcoal yakiniku - "螳峨￥縺ｦ譌ｨ縺・ (cheap and delicious) in a casual atmosphere.',
      popularity: 'Popular',
      avgPrice: '1500-2500ﾂ･'
    },
    {
    ...
    },
    {
      ...
      nameJp: '縺ｯ縺ｾ蟇ｿ蜿ｸ',
      category: 'Sushi',
      description: 'Conveyor belt sushi at 110ﾂ･ per piece with tablet ordering.',
      popularity: 'Very Popular',
      avgPrice: '100-120ﾂ･/piece'
    },
    {
      slug: 'hanamaru-udon',
      name: 'Hanamaru Udon',
    ...
    },
    {
      ...
      nameJp: '魑･雋ｴ譌・,
      category: 'Yakitori',
      description: 'Yakitori chain with a single price of 327ﾂ･ per skewer.',
      popularity: 'Very Popular',
      avgPrice: '327ﾂ･/skewer'
    },
    {
      slug: 'tsunahachi',
      name: 'Tsunahachi',
      ...
      <div className="bg-white border-t">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div className="text-2xl mb-3">骨</div>
            ...
            >
              <div className="text-2xl mb-3">導</div>
            ...
            >
              <div className="text-2xl mb-3">答</div>
