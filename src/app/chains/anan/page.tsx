...
export default function AnanPage() {
  ...
  const specialties = [
    ...
    },
    {
      ...
      description: "Application 'bui-wake' (部位わけ) - 50+ parties d'une carcasse - Anatomie bovine enseignée par l'assiette",
    ...
    },
    {
      ...
      description: "De 'hōrumon' (放るもの = jeté) à délicatesse - Transformation complète de chaque partie bovine",
