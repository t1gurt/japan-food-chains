...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "The guide to Japanese \"famiresu\" restaurants. Varied menus for all tastes (Gusto, Saizeriya) and a relaxed atmosphere ideal for groups.",
    type: "article",
    url: "https://japanfoodchains.com/food-type/family-restaurants",
  ...
  alternates: {
    canonical: "https://japanfoodchains.com/food-type/family-restaurants"
  },
  robots: {
    index: true,
    follow: true,
