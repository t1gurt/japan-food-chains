...
export default function FoodTypePage() {
  ...
  const getImplementationPath = (id: string) => {
    const implementedPages: { [key: string]: string } = {
      'gyudon': '/food-type/gyudon',
      'ramen': '/food-type/ramen', 
      'aburasoba': '/food-type/aburasoba',
      'kaiten-zushi': '/food-type/kaiten-zushi',
      'curry': '/food-type/curry',
      'tempura': '/food-type/tempura',
      'udon': '/food-type/udon',
      'soba': '/food-type/soba',
      'family-restaurants': '/food-type/family-restaurants',
      'burgers': '/food-type/burgers',
      'cuisine-chinoise': '/food-type/cuisine-chinoise',
      'izakaya': '/food-type/izakaya',
      'teishoku': '/food-type/teishoku',
      'cafe': '/food-type/cafe',
      'okonomiyaki': '/food-type/okonomiyaki',
      'street-food': '/food-type/street-food',
      'steak': '/food-type/steak',
      'yakiniku': '/food-type/yakiniku',
      'karaoke': '/food-type/karaoke'
    };
    
    return implementedPages[id] || `/food-type/${id}`;
  };
  ...
  return (
    <>
      <CategoryViewTracker categoryName="food-type-overview" />
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav className="text-sm">
              ...
              <span className="text-gray-900 font-medium">Search by Food Type</span>
            </nav>
          </div>
        </div>
