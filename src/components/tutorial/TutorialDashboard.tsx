...
const TutorialDashboard = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">Loading your learning profile...</p>
        </div>
      </div>
    );
  }
  ...
  const handleResetProgress = () => {
    ...
    setRefreshKey(prev => prev + 1); // Force re-render of all components
  };
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
          <div>
            ...
            <p className="text-lg text-gray-600">
              Continue your journey learning Japanese food culture
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wide">Total Points</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">{profile.completedLessons.length}/{lessons.length} lessons</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">out of {allBadges.length} available</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wide">Real Visits</h3>
                <p className="text-3xl font-bold text-purple-600">{profile.realStoreVisits}</p>
                <p className="text-sm text-gray-500">{profile.visitedChains.length} different chains</p>
              </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex-1">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-sm text-gray-500">{completedInLevel}/{nextLevelThreshold} lessons</span>
              </div>
            ...
            return (
              <div key={level} className={`${colors.bg} ${colors.border} border rounded-xl p-6`}>
                ...
                <p className={`${colors.accent} font-medium mb-4`}>
                  {completedInThisLevel}/{levelLessons.length} lessons completed
                </p>
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
          ...
          {profile.badges.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 text-lg">No badges yet</p>
              <p className="text-gray-400 text-sm">Start a lesson to earn your first badge!</p>
            </div>
          )}
        </div>
      </div>
            ...
            <div className="text-center">
              ...
              <div className="text-left bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                <ul className="space-y-2 text-sm text-orange-800">
                  <li>• All your points ({profile?.totalPoints || 0} points)</li>
                  <li>• All your badges ({profile?.badges.length || 0} badges)</li>
                  <li>• All your completed lessons ({profile?.completedLessons.length || 0} lessons)</li>
                  <li>• All your visit reports ({profile?.realStoreVisits || 0} visits)</li>
                </ul>
              </div>
