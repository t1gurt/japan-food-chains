...
const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'How to order 🎫', href: '/guides/how-to-order', icon: <></>, accent: 'text-blue-600' },
      { label: 'Culture & Etiquette 🙏', href: '/guides/culture-and-etiquette', icon: <></>, accent: 'text-purple-600' },
      { label: 'Dietary requirements 🥗', href: '/guides/dietary-requirements', icon: <></>, accent: 'text-green-600' },
...
const MobileNavigation: React.FC<MobileNavigationProps> = ({ isOpen, toggleMenu }) => {
  ...
  return (
    <>
      ...
      {/* Modernized Mobile Menu Panel - Fullscreen */}
      <nav
          ...
          <div className="p-6 border-t border-gray-100 bg-gradient-to-r from-gray-50 to-gray-100/50">
            <div className="text-center">
              <div className="flex items-center justify-center space-x-2 mb-3">
                ...
                <span className="text-sm font-medium text-gray-700">Japan Food Chains</span>
              </div>
              <p className="text-xs text-gray-500 mb-2">
                Your guide to Japanese restaurant chains
              </p>
