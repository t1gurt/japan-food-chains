...
| `src/app/chaines/hoshino/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
| `src/app/chaines/ichiran/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
...
| `src/app/chaines/komeda/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
| `src/app/chaines/komoro-soba/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
...
| `src/app/chaines/miyamoto-munashi/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
| `src/app/chaines/mos-burger/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
| `src/app/chaines/nakau/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
...
| `src/app/chaines/shirokiya/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
| `src/app/chaines/sukiya/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
| `src/app/chaines/sukiya-curry/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
...
| `src/app/chaines/torikizoku/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
| `src/app/chaines/tsunahachi/page.tsx` | コンテンツを英語に翻訳 | | (未着手) |
...
| `src/app/type-plat/family-restaurants/page.tsx` | コンテンツを翻訳 | | (未着手) |
...
| `src/app/type-plat/street-food/page.tsx` | コンテンツを翻訳 | | (未着手) |
...
| `src/app/type-plat/yakiniku/page.tsx` | コンテンツを翻訳 | | (未着手) |

### 1.5. その他ページ
| ファイルパス | 変換内容 | 備考 | ステータス |
| :--- | :--- | :--- | :--- |
| `src/app/contact/page.tsx` | フォームや案内文を翻訳 | | (未着手) |
| `src/app/layout.tsx` | ルートレイアウトの `lang` 属性を `fr` から `en` に変更、メタデータを翻訳 | | (未着手) |
| `src/app/page.tsx` | トップページのコンテンツを翻訳 | | (未着手) |
